...
exports.textData = function () {
    ...
    switch (z_adress) {
        case 'Девятаева 15а':
            sum_km += 8
            arrStrAdress.push('Пушкина8 - Девятаева15А=4<br>Девятаева15А - Пушкина8=4')
            break
        case 'Сары Садыковой 65':
            sum_km += 8
            arrStrAdress.push('Пушкина8 - СарыСадыковой65=4<br>СарыСадыковой65 - Пушкина8=4')
            break
        case 'Отрадная 5а':
            sum_km += 14
            arrStrAdress.push('Пушкина8 - Отрадная5а=7<br>Отрадная5а - Пушкина8=7')
            break
    }
    ...
    if (KM % 2 !== 0) {
        ...
        for (i; i < 25; i++) {
            if (!adressArr2.includes(adressArr[i])) {
                ...
                arrStrAdress.push(adressArrKmPlus[i])
    ...
    while (sum_km !== KM) {
        ...
        if (sum_km < KM) {
            ...
            if (raz_km <= 11) {
                ...
                while (raz_km !== 0) {
                    if (arr_km[a] === raz_km) {
                        if (!adressArr2.includes(adressArr[a])) {
                            sum_km += raz_km
                            arrStrAdress.push(adressArr[a])
    ...
    if (m_adress === 'Московская 43') {
        arrStrAdress.push('Пушкина8 - Московская43=3<br>Пушкина8 - Московская43=3')
    }
